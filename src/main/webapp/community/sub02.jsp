 ...
 <body>
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<!-- 검색 -->
	        <div class="row">
	            <form class="mt-3" method="get" action="../community/list.do?tname=guard">
			...
			<c:choose>    
			    ...
			    <c:otherwise>  <!-- 출력할 게시물이 있을때 -->
			        ...
			        <tr align="center">
			            ...
			            <td align="left"><!-- 제목 -->   
			                <a href="../community/view.do?tname=guard&idx=${ row.idx }">${ row.title }</a> 
			            </td> 
			            <td>${ row.id }</td><!-- 작성자 -->  
				...
				<div class="mb-3" style="padding-right:50px;">
					<div class="col d-flex justify-content-end" style="margin-left: 650px;">
						<button type="button" class="btn btn-danger btn-sm"
							onclick="location.href='../community/write.do?tname=guard';">글쓰기</button>
					</div>
					<!-- 페이징 처리 -->
					<div class="row mt-5">
					    <!-- <div class="col">
