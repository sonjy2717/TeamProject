...
//
String[] mobileArr = dto.getPhone_num().split("-");
			...
			<div class="right_contents">
				...
				<table cellpadding="0" cellspacing="0" border="0" class="join_box">
					...
					<tr>
						...
						<td><input type="text" name="name" value="<%= dto.getName() %>" class="join_input" /></td>     <!-- <a onclick="id_check_person(this.form);" style="cursor:hand;"><img src="../images/btn_idcheck.gif" alt="중복확인"/></a>-->
					</tr>
					<tr>
						<th><img src="../images/join_tit002.gif" /></th>
						<td><input type="text" name="id"  value="<%= dto.getId() %>" class="join_input" readonly/>&nbsp;</td>
					</tr>
					<tr>
					...
					<%-- <tr>
						...
						<td><input type="password" name="pass2" value="<%= dto.getName() %>" class="join_input" /></td>
					</tr>
					 --%>
	...
	<select name="last_email_check2" onChange="email_input(this.form);" class="pass" id="last_email_check2" >
		...
		<option value="yahoo.com" >yahoo.com</option>
					...
					<tr>
						...
						<td>
						<input type="text" name="zip1" value="<%= dto.getPostcode() %>"  class="join_input" style="width:100px;" />
						...
						<input type="text" name="addr1" value="<%= dto.getBasicadd() %>"  class="join_input" style="width:550px; margin-top:5px;" /><br>
						<input type="text" name="addr2" value="<%= dto.getDetailadd() %>"  class="join_input" style="width:550px; margin-top:5px;" />
