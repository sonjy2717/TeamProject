...
//nt totalCount = dao.selectCount(param);
int totalCount = dao.selectCount2(param,"정보");

//dao.practice(param,"1");
// List<BoardDTO> boardLists = dao.selectList(param); //모든게시판의 모든 게시물 출력용
List<BoardDTO> boardLists = dao.selectList2(param, "정보");
		...
		<div class="contents_box">
			...
			<div class="row">
				...
				<div class="row mb-3" style="padding-right:50px;">
					...
					<button type="button" class="btn btn-info"  onclick="location.href='sub05_write.jsp';">글쓰기</button>
